...
namespace NWH.VehiclePhysics2.Powertrain
{
    ...
    public partial class Powertrain : VehicleComponent
    {
        ...
        public override void Initialize()
        {
            ...
            // Warnings
            if (clutch.baseEngagementRPM < engine.idleRPM * 1.1f)
            {
                Debug.LogWarning($"Clutch engagement RPM is too  on vehicle {vc.name}. Clutch might stay engaged while in idle. Increase clutch" +
