...
namespace NWH.VehiclePhysics2.SetupWizard
{
    ...
    public partial class VehicleSetupWizard : MonoBehaviour
    {
        ...
        /// </summary>
        [Tooltip("Should the vehicle be added to the vehicles list of the VehicleChanger (if present in the scene)?")]
        ...
        public static void RunConfiguration(VehicleController targetVC, VehicleSetupWizardPreset preset)
        {
            ...
            switch (preset.vehicleType)
            {
                ...
                case VehicleSetupWizardPreset.VehicleType.SportsCar: inertiaBase = 0.12f;
                    break;
                case VehicleSetupWizardPreset.VehicleType.Motorcycle: inertiaBase = 0.1f;
                    break;
            ...
            // Clutch
            targetVC.powertrain.clutch.baseEngagementRPM          = Mathf.Max(1000f, preset.engineMaxRPM * 0.15f);
            targetVC.powertrain.clutch.variableEngagementRPMRange = preset.engineMaxRPM * 0.05f;
            ...
            if (preset.vehicleType == VehicleSetupWizardPreset.VehicleType.SportsCar ||
                preset.vehicleType == VehicleSetupWizardPreset.VehicleType.Motorcycle)
            {
                shiftDuration = 0.05f;
            ...
            foreach (WheelController wheelController in wheels)
            {
                ...
                if (preset.vehicleType == VehicleSetupWizardPreset.VehicleType.Motorcycle)
                {
                    wheelController.wheel.width = 0.05f;
                    wheelController.ForwardScanResolution = 7;
                    wheelController.SideToSideScanResolution = 1;
                }
            }
            ...
            foreach (WheelGroup wheelGroup in targetVC.WheelGroups)
            {
                ...
                if (preset.vehicleType == VehicleSetupWizardPreset.VehicleType.Motorcycle)
                {
                    ...
                    wheelGroup.camberAtBottom = 0;
                    wheelGroup.camberAtTop = 0;
                    wheelGroup.toeAngle = 0;
                    wheelGroup.antiRollBarForce = 0;
                }
            }
            ...
            if (preset.vehicleType == VehicleSetupWizardPreset.VehicleType.Motorcycle)
            {
                targetVC.inertiaTensor = new Vector3(50, 90, 35);
            }
            ...
            bool addCamera = true, bool addCharacterEnterExitPoints = true, bool registerWithVehicleChanger = true)
        {
            ...
            else
            {
                ...
                {
                    collider.gameObject.layer = 2; // Physics.IgnoreRaycast
                }
            }
            ...
            {
                VehicleChanger.Instance.vehicles.Add(vehicleController);
            }
