...
namespace NWH.VehiclePhysics2.Input
{
    ...
    public partial class VehicleInputHandler : VehicleComponent
    {
        ...
        /// Setting the value to 0 is not recommended if there can be any noise on the input
        /// as it might prevent vehicle from going into forward/reverse and similar issues.
        /// </summary>
        [Range(0.02f, 0.5f)]
        ...
        public override void Update()
        {
            ...
            // Apply deadzone
            states.throttle = states.throttle <= deadzone && states.throttle >= -deadzone ? 0 : states.throttle;
            states.brakes = states.brakes <= deadzone && states.brakes >= -deadzone ? 0 : states.brakes;
            states.steering = states.steering <= deadzone && states.steering >= -deadzone ? 0 : states.steering;
            states.clutch = states.clutch <= deadzone && states.clutch >= -deadzone ? 0 : states.clutch;
            states.handbrake = states.handbrake <= deadzone && states.handbrake >= -deadzone ? 0 : states.handbrake;
        }
